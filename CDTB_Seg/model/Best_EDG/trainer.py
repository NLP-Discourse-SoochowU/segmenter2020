...
from model.Best_EDG.model import Segment_Model
from config import *
from model.share import gen_batch_iter, check_max
from model.Best_EDG.metric import evaluate_
...
def main():
    ...
    scheduler = optim.lr_scheduler.ReduceLROnPlateau(optimizer, "max", factor=0.7, patience=17,
                                                     min_lr=7e-5) if LR_DECAY else None
