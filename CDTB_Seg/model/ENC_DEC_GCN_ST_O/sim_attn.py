...
class Sim_Attn(nn.Module):
    ...
    def forward(self, e_outputs, d_outputs):
        ...
        part1 = part1.bmm(h_d.transpose(1, 2)).transpose(1, 2).unsqueeze(-1)  # (batch, length_decoder, length_encoder, num_labels)
        ...
        s = part1 + part2 + part3 + self.b  # [batch, length_decoder, length_encoder, num_labels]
        return s
