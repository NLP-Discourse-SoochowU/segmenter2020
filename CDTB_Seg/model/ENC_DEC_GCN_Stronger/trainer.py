...
from model.ENC_DEC_GCN_Stronger.model import Segment_Model
from config import *
from model.share import gen_batch_iter, check_max
from model.ENC_DEC_GCN_Stronger.metric import evaluate_
...
def main():
    ...
    scheduler = optim.lr_scheduler.ReduceLROnPlateau(optimizer, "max", factor=0.1, patience=3) if LR_DECAY else None
